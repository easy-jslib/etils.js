/*
	Rollup.js v0.60.0
	Wed, 06 Jun 2018 05:24:58 GMT - commit 12a6ae0bf6d848438610282e197e50099801564b
...
*/
import path, { dirname, relative, extname, basename, resolve, sep } from 'path';
...
var Graph = /** @class */ (function () {
    function Graph(options) {
        ...
        this.contextParse = function (code, options) {
            if (options === void 0) { options = {}; }
            return _this.acornParse(code, Object.assign({}, defaultAcornOptions, options, _this.acornOptions));
        };
        ...
        return applyBuildStartHook(graph_1)
            ...
            function generate(rawOutputOptions, isWrite) {
                ...
                return createAddons(graph_1, outputOptions)
                    ...
                    return Promise.all(chunks.map(function (chunk) {
                        return chunk.render(outputOptions, addons).then(function (rendered) {
                            ...
                            return Promise.all(graph_1.plugins
                                ...
                                .map(function (plugin) {
                                return plugin.ongenerate.call(graph_1.pluginContext, outputOptions, outputChunk);
                            }));
                        });
                    })).then(function () { });
                })
                    ...
                    var generateBundleContext = Object.assign({}, graph_1.pluginContext, createAssetPluginHooks(assets, outputBundle, assetFileNames));
    ...
    return writeFile$1(filename, source)
        ...
        return isOutputChunk(outputFile) &&
            Promise.all(graph.plugins
                ...
                .map(function (plugin) {
                return plugin.onwrite.call(graph.pluginContext, Object.assign({ bundle: outputFile }, outputOptions), outputFile);
            }));
    })
        .then(function () { });
}
